...
class OKVQADatasetBLIP2Text(torch.utils.data.Dataset, ModuleParser):
    """
    ...
    def __getitem__(self, idx):
        ...
        sample = EasyDict({
            'img_caption': item.img_caption,#oscar
            'img_ocr': text_annotations,#ocr
            'objects': objects, #vinvl
    ...
    def collate_fn(self, batch):
        ...
        # text_based_vision_test = input_data.text_sequence
