...
class PrefixModelBLIP2ROI(pl.LightningModule):
    ...
    def forward(self, questions,
        ...
        if self.config.model_config.UseBLIP2:
            ...
            print("extended:", extended_questions.size)
            if self.config.ROI:
                ...
                print("slipt: ", split_qformer_input_ids.size)
    ...
    def generate(self, questions,
        ...
        if self.config.model_config.UseBLIP2:
            ...
            generated_text = self.generator_tokenizer.batch_decode(generation_outputs, skip_special_tokens=True)    
