...
def main():
    ...
    out_img_path = "/rds/user/kn413/hpc-work/Visual-Question-Answering/data/ok-vqa/2ROI_half_val2014"
    ...
    for i in tqdm(range(len(questions))):
        ...
        # Calculate half width for cropping
        half_width = width // 2
        ...
        new_id = f"{out_img_path}/{int(img_id):012d}_{question_id}_left.jpg"
        io.imsave(new_id, left_half)

        new_id = f"{out_img_path}/{int(img_id):012d}_{question_id}_right.jpg"
        io.imsave(new_id, right_half)
