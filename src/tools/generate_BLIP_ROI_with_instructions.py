...
def main():
    ...
    out_img_path = "/rds/user/kn413/hpc-work/Visual-Question-Answering/data/ok-vqa/2ROI_train2014"
    ...
    for i in tqdm(range(len(questions))):
        ...
        for obj in selected_objects:
            ...
            new_id = f"{out_img_path}/{int(img_id):012d}_{question_id}_{obj['class']}_{xmin}_{ymin}_{xmax}_{ymax}.jpg"
