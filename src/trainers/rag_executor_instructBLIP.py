...
from models.rag.rag_model_instructBLIP import RagModelInstructBLIP
from utils.dirs import *

class RagExecutorInstructBLIP(BaseExecutor):
    ...
    def _generative_step(self, sample_batched, batch_idx):
        ...
        print("OVDE ", test_batch["input_text_sequences"])
